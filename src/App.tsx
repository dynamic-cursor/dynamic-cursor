import { AnimateSharedLayout, motion, transform } from 'framer-motion';
  ...
  React.useEffect(() => {
    ...
    function onMouseMove(e: MouseEvent) {
      ...
      if (_menuRef.current) {
        ...
        const those = el.filter(e => e.id.startsWith('h-'));

        if (those.length > 0) {
          setCurrentSelected(those[0].id);
          console.log(those[0].id)
        }
      }
                  ...
                  <div className='circle'>
                    ...
                    >
                      <div style={{
                        ...
                        alignItems: "center",
                        color: "white",
                        scale: currentSelected == "h-1" ? 1.5 : 1,
                      }} id="h-1">
